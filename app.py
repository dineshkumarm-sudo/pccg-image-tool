...
if img_input is not None:
    ...
    # -------------------------------------------------------------
        ...
        with e_col2:
            ...
            """)
            st.success("✨ Your brush strokes on the left are dynamically scaled so that the downloaded image is crisp, un-stretched, and in the exact `960px` target resolution!")import streamlit as st
from PIL import Image, ImageOps
import io
import base64
import requests
